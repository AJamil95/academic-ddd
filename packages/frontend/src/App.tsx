...
import { EditProgramPage } from './components/pages/ProgramasPage/EditProgramPage';
import { RegisterProgramPage } from './components/pages/ProgramasPage/RegisterProgramPage';
